...
from liv_zones import preprocess_pancreas as pre
from liv_zones import organelle_pancreas as org
from liv_zones import cell_pancreas as c
...
image_paths = [
   ...
   "/path/to/your/data/Male/Region6/stack0/stack0.tif",
...
"/path/to/your/data/Male/Region6/stack0",
...
organelle_list = [ "mitochondria", "lipid_droplets", "peroxisomes", "large_peroxisomes"] #"mitochondria"
